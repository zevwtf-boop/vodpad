...
import { $, h } from './util.js?v=7cc5d8f531';
import { icon } from './icons.js?v=7cc5d8f531';
import { api, chooseBackend, isStatic, mode } from './api.js?v=7cc5d8f531';
import { state, bus, boot as loadState, saveNow } from './store.js?v=7cc5d8f531';
import { initTooltips, toast } from './ui.js?v=7cc5d8f531';
import { go, paintChrome, back, toggleMap } from './nav.js?v=7cc5d8f531';
import { applySettings, openGear } from './settings.js?v=7cc5d8f531';
import { installKeys } from './keys.js?v=7cc5d8f531';
import { installContextMenus } from './menus.js?v=7cc5d8f531';
import { openPalette } from './search.js?v=7cc5d8f531';
import { openReader } from './readmode.js?v=7cc5d8f531';
import { toggleVideo } from './video.js?v=7cc5d8f531';

import './dashboard.js?v=7cc5d8f531';
import './canvas.js?v=7cc5d8f531';
import './page.js?v=7cc5d8f531';
...
async function start() {
  ...
  if (mode === 'server') {
    ...
    const { alreadySignedIn, whoAmI } = await import('./api.js?v=7cc5d8f531');
    ...
    if (!name) {
      ...
      const { requireLogin } = await import('./gate.js?v=7cc5d8f531');
