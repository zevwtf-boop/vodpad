...
import { h, $, $$, uid, clamp, stripHtml, sanitizeInline, modKey, debounce } from './util.js?v=13c601f470';
import { icon } from './icons.js?v=13c601f470';
import { state, card, commit, quietly, syncTags, bus, undo } from './store.js?v=13c601f470';
import { contextMenu, toast } from './ui.js?v=13c601f470';
import { animate, EASE } from './motion.js?v=13c601f470';
import { renderImageBlock } from './images.js?v=13c601f470';
import { openSlashMenu, closeSlashMenu, slashOpen } from './toolbar.js?v=13c601f470';
...
function subPageEl(block) {
  ...
  return h('button.subpage-block', {
    on: {
      click: async (e) => {
        const { openCardPage } = await import('./nav.js?v=13c601f470');
...
async function tidyWires() {
  try { (await import('./wires.js?v=13c601f470')).pruneWires(); } catch { /* no wires module, fine */ }
}
...
async function onPaste(e, body, blockId) {
  ...
  if (imageItem) {
    ...
    const { insertImageFromFile } = await import('./images.js?v=13c601f470');
