...
import { state, bus, openBoard, closeBoard, saveNow, pathTo, cardTitle, card, forceSave } from './store.js?v=7cc5d8f531';
import { ghostTo } from './motion.js?v=7cc5d8f531';
import { toast, openModal } from './ui.js?v=7cc5d8f531';
...
bus.on('conflict', async () => {
  ...
  try {
    ...
    if (pick === 'history') {
      ...
      await (await import('./history.js?v=7cc5d8f531')).openHistory();
