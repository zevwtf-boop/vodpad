...
import { h, clear, fmtRel, fmtDate, fmtBytes, stripHtml } from './util.js?v=764fd7e397';
import { icon } from './icons.js?v=764fd7e397';
import { api } from './api.js?v=764fd7e397';
import { state, commit, saveNow } from './store.js?v=764fd7e397';
import { openModal, toast, confirmDialog } from './ui.js?v=764fd7e397';
...
async function restore(boardId, v, close) {
  ...
  const { go } = await import('./nav.js?v=764fd7e397');
