...
import { h, clear, fmtRel, fmtDate, fmtBytes, stripHtml } from './util.js?v=7cc5d8f531';
import { icon } from './icons.js?v=7cc5d8f531';
import { api } from './api.js?v=7cc5d8f531';
import { state, commit, saveNow } from './store.js?v=7cc5d8f531';
import { openModal, toast, confirmDialog } from './ui.js?v=7cc5d8f531';
...
async function restore(boardId, v, close) {
  ...
  const { go } = await import('./nav.js?v=7cc5d8f531');
