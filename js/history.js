...
import { h, clear, fmtRel, fmtDate, fmtBytes, stripHtml } from './util.js?v=66fb115653';
import { icon } from './icons.js?v=66fb115653';
import { api } from './api.js?v=66fb115653';
import { state, commit, saveNow } from './store.js?v=66fb115653';
import { openModal, toast, confirmDialog } from './ui.js?v=66fb115653';
...
async function restore(boardId, v, close) {
  ...
  const { go } = await import('./nav.js?v=66fb115653');
