...
export async function chooseBackend() {
  ...
  if (config && config.api) {
    const cloud = await import('./cloud.js?v=d258d51ea6');
...
export async function signOut() {
  if (mode === 'cloud') (await import('./cloud.js?v=d258d51ea6')).logout();
  else (await import('./vault.js?v=d258d51ea6')).lock();
  location.reload();
}

export async function whoAmI() {
  if (mode === 'cloud') return (await import('./cloud.js?v=d258d51ea6')).cloudUser();
  if (mode === 'vault') return (await import('./vault.js?v=d258d51ea6')).currentUser();
  return null;
}
