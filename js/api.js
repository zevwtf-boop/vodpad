...
export async function chooseBackend() {
  ...
  if (config && config.api) {
    const cloud = await import('./cloud.js?v=7cc5d8f531');
  ...
  const vault = await import('./vault.js?v=7cc5d8f531');
  api = vault.localApi;
...
export async function signOut() {
  if (mode === 'cloud') (await import('./cloud.js?v=7cc5d8f531')).logout();
  else (await import('./vault.js?v=7cc5d8f531')).lock();
  location.reload();
}

export async function whoAmI() {
  if (mode === 'cloud') return (await import('./cloud.js?v=7cc5d8f531')).cloudUser();
  if (mode === 'vault') return (await import('./vault.js?v=7cc5d8f531')).currentUser();
  return null;
}
