...
import { $, $$, h, uid } from './util.js?v=66fb115653';
import { state, card, commit, quietly } from './store.js?v=66fb115653';
import { toast } from './ui.js?v=66fb115653';
import { ping, animate } from './motion.js?v=66fb115653';
...
function wire() {
  ...
  document.addEventListener('contextmenu', async (e) => {
    ...
    if (!mark) return;
    e.preventDefault();
    const { contextMenu } = await import('./ui.js?v=66fb115653');
    contextMenu([
