...
import { $, h, clear, clamp, fmtClock, fmtBytes, parseClock } from './util.js?v=7cc5d8f531';
import { icon } from './icons.js?v=7cc5d8f531';
import { api, videoUrl } from './api.js?v=7cc5d8f531';
import { state, card, commit, quietly, bus } from './store.js?v=7cc5d8f531';
import { toast, contextMenu, promptDialog, popover, closePopover } from './ui.js?v=7cc5d8f531';
...
export async function pickFrame() {
  ...
  const { openModal } = await import('./ui.js?v=7cc5d8f531');
