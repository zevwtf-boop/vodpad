...
import { $, h, clear, clamp, fmtClock, fmtBytes, parseClock } from './util.js?v=13c601f470';
import { icon } from './icons.js?v=13c601f470';
import { api, videoUrl } from './api.js?v=13c601f470';
import { state, card, commit, quietly, bus } from './store.js?v=13c601f470';
import { toast, contextMenu, promptDialog, popover, closePopover } from './ui.js?v=13c601f470';
...
export async function pickFrame() {
  ...
  const { openModal } = await import('./ui.js?v=13c601f470');
